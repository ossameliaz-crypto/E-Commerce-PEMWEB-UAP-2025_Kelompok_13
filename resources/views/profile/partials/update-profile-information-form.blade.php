    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input 
                ...
                name="name" 
                type="text" 
                {{-- STYLE INPUT TERANG (Anti Dark Mode) --}}
        ...
        {{-- PHONE NUMBER --}}
        <div>
            <x-input-label for="phone_number" :value="__('Phone Number')" class="text-gray-900 font-bold" />
            <x-text-input 
                id="phone_number" 
                name="phone_number" 
                type="tel" 
                ...
                {{-- Mengisi data phone_number dari database --}}
