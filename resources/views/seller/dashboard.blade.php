    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 min-h-screen hidden md:block fixed">
            ...
            <nav class="p-4 space-y-2 mt-4">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-bold rounded-xl transition">
                    <span>💰</span> Pesanan
                </a>
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-bold rounded-xl transition">
        ...
        <main class="flex-1 md:ml-64 p-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                ...
                <button class="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-xl font-bold shadow-lg shadow-orange-500/30 transition transform hover:-translate-y-1 flex items-center gap-2">
                            ...
                            <tr class="hover:bg-orange-50/30 transition group">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="font-bold text-gray-800">Kaos Merah UAP</span>
                                    </div>
                                </td>
                                <td class="px-6 py-5 font-mono text-gray-600">Rp 50.000</td>
                                <td class="px-6 py-5 text-gray-600">120</td>
                                <td class="px-6 py-5"><span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">Aktif</span></td>
                                <td class="px-6 py-5 text-right">
                                    <button class="text-gray-400 hover:text-blue-600 font-bold mr-3 transition">Edit</button>
                                    <button class="text-gray-400 hover:text-red-600 font-bold transition">Hapus</button>
                                </td>
                            </tr>
                            <tr class="hover:bg-orange-50/30 transition group">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center text-xl group-hover:scale-110 transition">🧥</div>
                                        <span class="font-bold text-gray-800">Hoodie Biru</span>
                                    </div>
                                </td>
                                <td class="px-6 py-5 font-mono text-gray-600">Rp 75.000</td>
                                <td class="px-6 py-5 text-gray-600">50</td>
                                <td class="px-6 py-5"><span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">Aktif</span></td>
                                <td class="px-6 py-5 text-right">
                                    <button class="text-gray-400 hover:text-blue-600 font-bold mr-3 transition">Edit</button>
                                    <button class="text-gray-400 hover:text-red-600 font-bold transition">Hapus</button>
